    ...
    <div className="grid grid-cols-12 h-screen lg:container lg:mx-auto gap-3">
      <div className="col-span-12 md:col-span-12 lg:col-span-2 bg-gray-100 flex flex-col p-10  gap-6">
        ...
        <div className="text-sm p-2 bg-white rounded">
          ...
          content creator yang baru bergabung di Trakteer.id. Mohon dukungannya
          ya!
        </div>
      </div>
      <div className="col-span-12 md:col-span-12 lg:col-span-8 lg:max-h-screen lg:overflow-x-auto">
      ...
      <div className="col-span-12 md:col-span-12 lg:col-span-2 bg-gray-100 flex flex-col  lg:max-h-screen lg:overflow-x-auto  order-2 lg:order-last">
        {[...Array(20)].map((e, i) => (
          <div
            key={i}
